...
for tool in tools :
    buttons.append(pygame.image.load(f'./image/paint/{tool}.png'))

bucket = pygame.image.load('./image/paint/bucket_black.png')
...
while running:
  ...
  if drawBucket() and event.type == pygame.MOUSEBUTTONDOWN :
        ...
        #Border
            ...
            width = 0
            bucket = pygame.image.load('./image/paint/bucket_blue.png')
            screen.blit(bucket, (1026, 290))
