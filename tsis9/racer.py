...
#Setting up Images
main_bg = pygame.image.load('./image/cave.jpg') #BG on game over
background = pygame.image.load("./image/AnimatedStreet.png") #BG on playing
...
cars_path = os.path.join(os.getcwd(), './image/cars')
cars = list()
for image in os.listdir(cars_path) :
    cars.append(pygame.image.load(f'{cars_path}/{image}'))

#Randomly choosing coin image
coin_images = [pygame.image.load('./image/coin.png'), pygame.image.load('./image/red_coin.png')]
coin_image = coin_images[0]
for i in range(3) :
    coin_images.append(pygame.image.load('./image/coin.png'))


#Setting up Sounds
coin_sound = pygame.mixer.Sound('./mp3/coin.ogg')
game_over_theme_sound = pygame.mixer.Sound('./mp3/game_over.ogg')
pygame.mixer.music.load('./mp3/drive_sound.ogg')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load('./image/cars/Player.png')
        self.image = pygame.transform.scale(self.image, (70 ,140))
        self.rect = self.image.get_rect()
...
quit_button_image = pygame.image.load('./image/quit.jpg')
restart_button_image = pygame.image.load('./image/restart.jpg')
